...
async def start(client, message):
    ...
    loading_sticker_message = await message.reply_sticker("CAACAgUAAxkBAAKNg2dNPuPSVsAyZEOafOTpMpR3h5VDAAJIDAACxbrRVXniBxhJF1BeNgQ")
    ...
    button = InlineKeyboardMarkup([
        [InlineKeyboardButton("📢 Updates", url="https://t.me/AeroBots_Tm"),
        InlineKeyboardButton("💬 Support", url="https://t.me/AeroBots_Group")],
        [InlineKeyboardButton("🛠️ Help", callback_data='help'),
        InlineKeyboardButton("❤️‍🩹 About", callback_data='about')],
        [InlineKeyboardButton("🧑‍💻 Developer 🧑‍💻", url="https://telegram.me/Mikoyo")]
        ])
